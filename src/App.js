      ...
      <>
        ...
        <Routes>
          ...
          {this.category.map((category, index) => {
            return <Route key={index} exact path={`/${category}`} element={<News key={index} setProgress={this.setProgress} apiKey={this.apiKey} pageSize={this.pageSize} country={this.country} category={category} />} />;
          })}
